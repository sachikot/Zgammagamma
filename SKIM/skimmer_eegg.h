...
// Fri May  9 17:10:06 2014 by ROOT version 5.32/00
// from TTree EventTree/Event data
// found on file: /eos/uscms/store/user/iraklis/ggNtuples/job_summer12_Zg.root
//////////////////////////////////////////////////////////

#ifndef skimmer_eegg_h
#define skimmer_eegg_h
...
public :
   ...
   skimmer_eegg(TString fileName);
   virtual ~skimmer_eegg();
...
#ifdef skimmer_eegg_cxx
skimmer_eegg::skimmer_eegg(TString fileName) : fChain(0) 
{
...
skimmer_eegg::~skimmer_eegg()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t skimmer_eegg::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t skimmer_eegg::LoadTree(Long64_t entry)
{
...
void skimmer_eegg::Init(TTree *tree)
{
...
void skimmer_eegg::Show(Long64_t entry)
{
...
Int_t skimmer_eegg::Cut(Long64_t entry)
{
