...
// Tue Sep  8 18:38:29 2015 by ROOT version 5.34/10
// from TTree EventTree/Event data
// found on file: /uscmst1b_scratch/lpc1/old_scratch/lpceg/yurii/EnSc/Zgg/officialSample/crab_projects_ntuples_25ns/crab_job_ZGG/results/llaa_nlo_ggNtuple.root
//////////////////////////////////////////////////////////

#ifndef skimmer_mumugg_h
#define skimmer_mumugg_h
...
class skimmer_mumugg {
 public :
  ...
  skimmer_mumugg(TString fileName);
  virtual ~skimmer_mumugg();
...
#ifdef skimmer_mumugg_cxx
skimmer_mumugg::skimmer_mumugg(TString fileName) : fChain(0) 
{
...
skimmer_mumugg::~skimmer_mumugg()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t skimmer_mumugg::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t skimmer_mumugg::LoadTree(Long64_t entry)
{
...
void skimmer_mumugg::Init(TTree *tree)
{
...
void skimmer_mumugg::Show(Long64_t entry)
{
...
Int_t skimmer_mumugg::Cut(Long64_t entry)
{
...
#endif // #ifdef skimmer_mumugg_cxx
