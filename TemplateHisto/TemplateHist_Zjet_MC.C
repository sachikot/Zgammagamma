#define TemplateHist_Zjet_MC_cxx
#include "TemplateHist_Zjet_MC.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include "iostream"
...
void TemplateHist_Zjet_MC::Loop(TString name, TString fitVal, int iso)
{
...
int main(int argc, char* argv[]){
  ...
  for (int i = 0; i < argc; i++ ) {
    ...
    TemplateHist_Zjet_MC t("/uscmst1b_scratch/lpc1/old_scratch/lpceg/yurii/EnSc/sachiko/Zgg/NEW_WORK_09010/Zgg/RootForTemp/ZgBkg/muon_Zg_"+fitVal+"_"+_iso[iso]+"_Bkg.root");
    t.Loop("ROOT_BkgMC/muon_Bkg_"+fitVal+"_"+_iso[iso]+".root", fitVal, iso);
  }
