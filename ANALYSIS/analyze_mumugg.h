...
#ifndef analyze_Zgg_h
#define analyze_Zgg_h
...
#ifdef analyze_Zgg_cxx
analyze_Zgg::analyze_Zgg(TTree *tree) : fChain(0)
{
...
analyze_Zgg::~analyze_Zgg()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t analyze_Zgg::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analyze_Zgg::LoadTree(Long64_t entry)
{
...
void analyze_Zgg::Init(TTree *tree)
{
...
void analyze_Zgg::Show(Long64_t entry)
{
...
Int_t analyze_Zgg::Cut(Long64_t entry)
{
