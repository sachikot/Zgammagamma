...
// Wed Sep 16 11:01:12 2015 by ROOT version 5.34/10
// from TTree EventTree/Event data
// found on file: /uscmst1b_scratch/lpc1/old_scratch/lpceg/yurii/EnSc/sachiko/Zgg/NEW_SKIM/Muon/OnlyMuTight/dimu_trigger/job_2muon_2012a_Jan22rereco_skimmed_zgg.root
//////////////////////////////////////////////////////////

#ifndef analyze_Zjet_h
#define analyze_Zjet_h
...
const double photonID_RhoCorrChHadIso[2][7]       = { {1.5, 5, 8, 10, 12, 15, 20} ,  {1.2, 5, 8, 10, 12, 15, 20} };
const double photonID_RhoCorrPhoIso[2][7]         = { {0.7, 3, 5, 7, 9, 11, 16} ,    {1.0, 3, 5, 7, 9, 11, 16}   };
const double photonID_RhoCorrNeuHadIso[2][7]      = { {1.0, 3, 5, 7, 9, 11, 16} ,    {1.5, 3, 5, 7, 9, 11, 16}   };
const double photonID_SigmaIhIh[2][2]             = { {0.011, 0.029}, {0.033, 0.087} };

const TString Loose[7] = {"nomi", "533", "855", "1077", "1299", "151111", "201616"};
...
class analyze_Zjet {
 public :
  ...
  Float_t         puWeight_p5;
  Float_t         totalWeight;
  Float_t         totalWeight_p5;
  Float_t         totalWeight_m5;
  ...
  TBranch        *b_totalWeight_p5;   //!
  TBranch        *b_totalWeight_m5;   //!

  analyze_Zjet(TTree *tree=0);
  virtual ~analyze_Zjet();
  virtual Int_t    Cut(Long64_t entry);
  virtual Int_t    GetEntry(Long64_t entry);
  virtual Long64_t LoadTree(Long64_t entry);
  virtual void     Init(TTree *tree);
  //  virtual void     Loop(TString name);
  virtual void     Loop(TString name, TString fitVal, int iso);
  virtual Bool_t   Notify();
  virtual void     Show(Long64_t entry = -1);
  virtual void     clearVariables();
  virtual bool     muID2012(int i);
  virtual float    MuIsolation(int i);
...
#ifdef analyze_Zjet_cxx
analyze_Zjet::analyze_Zjet(TTree *tree) : fChain(0)
{
  // if parameter tree is not specified (or zero), connect the file
  // used to generate this class and read the Tree.
  TChain* chain = new TChain("EventTree");
  chain->Add("/uscmst1b_scratch/lpc1/old_scratch/lpceg/yurii/EnSc/sachiko/Zgg/NEW_SKIM/Muon/CrossCheck/job_2muon_2012a_Jan22rereco_skimmed_zgg.root");
  chain->Add("/uscmst1b_scratch/lpc1/old_scratch/lpceg/yurii/EnSc/sachiko/Zgg/NEW_SKIM/Muon/CrossCheck/job_2muon_2012b_Jan22rereco_skimmed_zgg.root");
  chain->Add("/uscmst1b_scratch/lpc1/old_scratch/lpceg/yurii/EnSc/sachiko/Zgg/NEW_SKIM/Muon/CrossCheck/job_2muon_2012d_Jan22rereco_skimmed_zgg.root");
  chain->Add("/uscmst1b_scratch/lpc1/old_scratch/lpceg/yurii/EnSc/sachiko/Zgg/NEW_SKIM/Muon/CrossCheck/job_2muon_2012c_Jan22rereco_skimmed_zgg.root");
  //  chain->Add("/uscmst1b_scratch/lpc1/old_scratch/lpceg/yurii/EnSc/sachiko/Zgg/NEW_SKIM/Muon/CrossCheck/run207099.root");

  tree = chain;
  Init(tree);
}

analyze_Zjet::~analyze_Zjet()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t analyze_Zjet::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analyze_Zjet::LoadTree(Long64_t entry)
{
...
void analyze_Zjet::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("totalWeight_p5", &totalWeight_p5, &b_totalWeight_p5);
   fChain->SetBranchAddress("totalWeight_m5", &totalWeight_m5, &b_totalWeight_m5);
   Notify();
}

Bool_t analyze_Zjet::Notify()
{
...
void analyze_Zjet::Show(Long64_t entry)
{
...
Int_t analyze_Zjet::Cut(Long64_t entry)
{
